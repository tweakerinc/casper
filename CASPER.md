...
```bat
robocopy C:\Users\m\CrossInk E:\casper /E /XD .git .pio /XF tmp_title_chunk.txt CASPER.md /NFL /NDL /NJH /NJS
```

(`CASPER.md` on this tree is the full reference doc; the worktree has a shorter dual-tree note.)
...
- Status bar time estimate suffix: `2h 15m left`
