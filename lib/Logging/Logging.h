...
void clearLastLogs();
// Optional SD mirror for LOG_* lines. Null disables. SystemLog registers this
// when Enable Logging is on so field captures include serial INF/ERR.
void setLogMirror(void (*fn)(const char* line));
